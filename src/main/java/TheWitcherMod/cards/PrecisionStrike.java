...
public final class PrecisionStrike extends AbstractDefaultCard {
    public static final String ID = TheWitcherModMain.makeID(PrecisionStrike.class.getSimpleName());
